...
def main():
    ...
    FinalVocab = set(FromDocVocab + LexVocab)
    ...
    # SelectedFeatsVocab = SelectFeatures (TrainFVs,
    #         y_train,
    #         FeatuesToSelect = 1000,
    #         FSAlgo = chi2,
    #         DispSelectedFeatures = True,
    #         Vocab = FinalVocab)
    #
    # CVectorizer = CountVectorizer(lowercase = True,
    #                               stop_words='english',
    #                               vocabulary=SelectedFeatsVocab,
    #                               tokenizer = Tokenizer,
    #                               ngram_range=(1,2),
    #                               dtype=np.float64,
    #                               decode_error = 'ignore')
